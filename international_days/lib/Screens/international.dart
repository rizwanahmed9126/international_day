...
class INTERNATIONAL extends StatefulWidget {
  ...
  const INTERNATIONAL({Key key,this.zoomController}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              RowText(
                firstTxt: 'INTERNATIONAL',
                secondTxt: '02-January',
                secondTxtStyle: TextStyle(color: Colors.blue),
              ),
              DaysPanel(
                todayTxt: 'INTERNATIONAL',
              ),

              Padding(
                padding: const EdgeInsets.only(left: 18.0,right: 8),
                child: RowText(
                  firstTxt: 'INTERNATIONAL NEWS',
                  secondTxt: 'More',
                  secondTxtStyle: TextStyle(color: Colors.blue),
